...
function initialisation()
{
	...
	nbxg = 5;   // Nombre de Pommes à GAUCHE (a)
	nbg  = 6;   // Nombre d'unités à GAUCHE (b)
	
	nbxd = 2;   // Nombre de Pommes à DROITE (c)
	nbd  = 18;  // Nombre d'unités à DROITE (d)
	...
	if (nbxg != nbxd) {
		...
		alert("Erreur : Impossible d'avoir le même nombre de pommes des deux côtés !");
		valx = 1; 
	}
	
	// Si le résultat n'est pas un nombre entier, l'affichage risque d'être bizarre.
	// Assurez-vous de choisir des équations qui tombent juste !
	// --- FIN DE VOS MODIFICATIONS ---

	
	/* --- ANCIEN CODE ALEATOIRE (Désactivé) ---
